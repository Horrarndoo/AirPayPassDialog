...
public class PayPassDialog {
    ...
    public PayPassDialog(Context context) {
        ...
        this.mThemeResId = R.style.dialog_airpay_theme;
        this.mDialogLayout = LayoutInflater.from(mContext).inflate(R.layout.dialog_airpaypass,
                null);
        ...
        window.setWindowAnimations(R.style.openAnim);  //添加动画
